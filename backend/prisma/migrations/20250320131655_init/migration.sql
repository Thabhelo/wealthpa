-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CLIENT', 'PA', 'ADMIN');

-- CreateEnum
CREATE TYPE "SubscriptionTier" AS ENUM ('STARTER', 'GROWTH', 'PREMIUM');
...
-- AddForeignKey
ALTER TABLE "Match" ADD CONSTRAINT "Match_paId_fkey" FOREIGN KEY ("paId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
